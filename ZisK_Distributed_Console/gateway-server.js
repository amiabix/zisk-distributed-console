...
function findProtoPath() {
  ...
  const possiblePaths = [
    '/Users/abix/Downloads/ZisK_Data/zisk/distributed/crates/grpc-api/proto/zisk_distributed_api.proto',
    path.join(__dirname, '../../Downloads/ZisK_Data/zisk/distributed/crates/grpc-api/proto/zisk_distributed_api.proto'),
  ...
  // Return first path as default (will fail with clear error)
